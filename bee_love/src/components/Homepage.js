...
const Homepage = ({title, description, imgsrc, alt}) => {
  return (
    <div>
      <div className='container grid grid-cols-1 md:grid-cols-2 gap-4 flex-col bg-transparent md:flex-row'>
        <div className='mt-4 md:mt-12 xl:mt-24 2xl:mt-24 flex flex-col space-y-4 md:space-y-6 lg:space-y-10'>
        ...
        <div>
            <img className='object-cover w-full' src={imgsrc} alt={alt} />
        </div>
      </div>
    </div>
  )
